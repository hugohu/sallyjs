...
(function(factory) {
  ...
  // code
  $.throttle=function(a,b,c,d){function g(){function j(){f=+new Date,c.apply(g,i)}function k(){e=void 0}var g=this,h=+new Date-f,i=arguments;d&&!e&&j(),e&&clearTimeout(e),void 0===d&&h>a?j():b!==!0&&(e=setTimeout(d?k:j,void 0===d?a-h:a))}var e,f=0;return"boolean"!=typeof b&&(d=c,c=b,b=void 0),$.guid&&(g.guid=c.guid=c.guid||$.guid++),g};
  
  $.roll = function(eventanme, fn) {
    $.roll[eventanme] = fn;
  };
$.extend($.roll, {
